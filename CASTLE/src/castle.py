...
class CASTLE:
    ...
    def __init__(
        ...
        # All parameters from the config file
        self.params = params
        # The headers to use for k-anonymity
        self.headers: List[str] = params.quasi_identifiers
        # The sensitive attribute
        self.sensitive_attr: str = params.sensitive_attribute
